	...
	module.exports = function(collectionName, prettyCollectionName){
		var mongodb = require("mongodb");
		var database = require("./database");
		var q = require("q");
		var _collectionName="";
		var _prettyCollectionName = "";

		_collectionName = collectionName;
		if (prettyCollectionName){
			_prettyCollectionName = prettyCollectionName;
		} else {
			_prettyCollectionName = _collectionName;
		}
		...
		this.getByTitle = function(title){
			...
			database.getDb(function(err, db){
				...
				db[_collectionName].findOne({ title: title }, function(err, collectionItemFound){
					if (err) {
						deferred.reject("Find of " + _prettyCollectionName + " with title " + title + " failed with error: " + err);
						return;
					}

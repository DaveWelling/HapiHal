module.exports = function (config) {
    config.set({
		...
		files: [
            ...
            { pattern: 'bower_components/api-check/dist/api-check.js', watched: false, included: true, served: true },
			{ pattern: 'bower_components/angular-formly/dist/formly.js', watched: false, included: true, served: true },
